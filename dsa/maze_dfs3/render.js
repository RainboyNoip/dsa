...
function render_stack(_status,_delay){
  console.log(_status.stack)
  let sU = stack_back.selectAll("g#b").data(_status.stack)
  let sE = sU.enter()
  let sR = sU.exit()
...
function render_init(){
  ...
  stack_back =gsvg.append("g").attr("id","stack")
  explain();
}
